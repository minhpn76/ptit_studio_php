        ...
        <div class="menu-inner">
            ...
            <div class="menu__nav" >
                <ul class="d-flex align-items-end align-items-md-center">
                    <li data-aos="fade-up" class="active"><a href="works">Works</a></li>
                    <li data-aos="fade-up" data-aos-delay="100"><a href="services">Services</a></li>
                    <li data-aos="fade-up" data-aos-delay="200"><a href="contact">Contact</a></li>
                </ul>
